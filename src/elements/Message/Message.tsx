...
export interface StrictMessageProps {
   ...
   * Called when the user clicks the "x" icon. also adds the "x" icon.
   *
...
interface CMessage extends React.FC<MessageProps> {
...
export const Message: CMessage = props => {
  ...
  const handleDismiss = (e: any) => onDismiss && onDismiss(e, props);
