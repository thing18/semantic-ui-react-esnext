...
export type SemanticProps<T> = T & Record<string, any>;
...
export type HtmlLabelProps = SemanticProps<StrictHtmlLabelProps>;
...
export type SemanticShorthandItemFunc<TProps> = (component: React.ReactType<TProps>, props: TProps, children?: React.ReactNode | React.ReactNodeArray) => React.ReactElement<any> | null;
export type SemanticShorthandContent = React.ReactNode;
export type SemanticShorthandItem<TProps> = React.ReactNode | TProps | SemanticShorthandItemFunc<TProps>;
...
export type SemanticCOLORS = 'red' | 'orange' | 'yellow' | 'olive' | 'green' | 'teal' | 'blue' | 'violet' | 'purple' | 'pink' | 'brown' | 'grey' | 'black';
...
export interface FCX<P> extends React.FC<P> {
